...
// Rarity grades with drop rates
export const RARITY_GRADES = ['SS', 'S', 'A', 'B', 'C', 'D', 'E'] as const;
...
export const ROLE_BASE_STATS = {
  DPS: { hp: 100, atk: 80, def: 50, speed: 70, em: 60 },
  BurstDPS: { hp: 90, atk: 90, def: 40, speed: 60, em: 80 },
  Support: { hp: 110, atk: 40, def: 70, speed: 65, em: 90 },
  Tank: { hp: 120, atk: 30, def: 90, speed: 40, em: 50 },
  Control: { hp: 100, atk: 50, def: 60, speed: 75, em: 85 }
};

// Removed old rarity multipliers - using RARITY_STAT_MULTIPLIERS now
